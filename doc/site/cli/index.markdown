...
**The Fodi Command-Line Interface** is a tool you can run which gives you a way to run Fodi code, and
...
Fodi as a language is intentionally designed to be minimal.   
...
That's what the CLI project is! It is not bundled as part of the fodi project,
...
Fodi CLI is a work in progress, and contributions are welcome to make it more useful over time.

## Why does it exist?

- It's fun to make things.
- It's always a good idea to test the language you're making!
- Interest was expressed in a scriptable tool using the Fodi language.
