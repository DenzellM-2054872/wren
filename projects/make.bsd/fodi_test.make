...
TARGETDIR = ../../bin
TARGET = $(TARGETDIR)/fodi_test
OBJDIR = obj/64bit/Release/fodi_test
DEFINES += -DNDEBUG
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -O2 -std=c99
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -O2
LIBS += ../../lib/libfodi.a -lm
LDDEPS += ../../lib/libfodi.a
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64 -s

else ifeq ($(config),release_32bit)
TARGETDIR = ../../bin
TARGET = $(TARGETDIR)/fodi_test
OBJDIR = obj/32bit/Release/fodi_test
DEFINES += -DNDEBUG
...
TARGETDIR = ../../bin
TARGET = $(TARGETDIR)/fodi_test
OBJDIR = obj/64bit-no-nan-tagging/Release/fodi_test
...
TARGETDIR = ../../bin
TARGET = $(TARGETDIR)/fodi_test_d
OBJDIR = obj/64bit/Debug/fodi_test
DEFINES += -DDEBUG
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -g -std=c99
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -g
LIBS += ../../lib/libfodi_d.a -lm
LDDEPS += ../../lib/libfodi_d.a
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64

else ifeq ($(config),debug_32bit)
TARGETDIR = ../../bin
TARGET = $(TARGETDIR)/fodi_test_d
OBJDIR = obj/32bit/Debug/fodi_test
DEFINES += -DDEBUG
...
TARGETDIR = ../../bin
TARGET = $(TARGETDIR)/fodi_test_d
OBJDIR = obj/64bit-no-nan-tagging/Debug/fodi_test
...
OBJECTS += $(OBJDIR)/call_fodi_call_root.o
...
$(OBJDIR)/call_calls_foreign.o: ../../test/api/call_calls_foreign.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(ALL_CFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/call_fodi_call_root.o: ../../test/api/call_fodi_call_root.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(ALL_CFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
