This contains the Fodi source code. It is organized like so:
...
*   `vm`: the source code for the Fodi VM itself. If you are embedding the VM in
    your own application from source, you will compile the files here into your
    app.

*   `optional`: the Fodi and C source code for the optional modules. These are
