#ifndef fodi_compiler_h
#define fodi_compiler_h
...
// This module defines the compiler for Fodi. It takes a string of source code
// and lexes, parses, and compiles it. Fodi uses a single-pass compiler. It
...
// Compiles [source], a string of Fodi source code located in [module], to an
